...
const props = defineProps<{
    quotes_list: QuoteListResponse;
}>();

const quotes = computed(() => {
    return props.quotes_list.data
})
                ...
                <div class="tab-content border-base-300 p-10">
                    <table class="min-w-full divide-y divide-gray-200 overflow-x-auto">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr :key="quote.id" v-for="quote in quotes" class="hover:bg-gray-50 cursor-pointer"
                                @click="() => router.visit(route('lead_details', { quote: quote.id }))">
