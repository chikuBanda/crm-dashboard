      ...
      <div class="flex items-center justify-between h-16 bg-white border-b border-gray-200">
        <div class="flex items-center px-4">
          ...
          <div class="relative mx-auto text-gray-600">
            <input
              class="border border-gray-300 h-10 w-96 px-5 pr-16 rounded-lg text-sm placeholder-current focus:outline-none dark:bg-gray-500 dark:border-gray-50 dark:text-gray-200"
            ...
            <button type="submit" class="absolute right-1 top-0 mt-3 mr-4">
              <svg class="text-gray-600 dark:text-gray-200 h-4 w-4 fill-current" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 56.966 56.966"
        ...
        <div class="flex items-center space-x-4 mr-4">
          ...
          <!-- logout -->
          <a href="#"
            class="flex items-center text-gray-600 hover:text-gray-800 dark:text-gray-200 dark:hover:text-gray-300">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <path fill="currentColor"
          ...
          <div class="tab-content border-base-300 p-10">
            <table class="min-w-full divide-y divide-gray-200 overflow-x-auto">
                ...
                <tr>
                  <th scope="col"
                    ...
                    <input id="quote_select_all" type="checkbox" class="checkbox border"
                      @change="(evt) => toggleAllSelectedQuotes(evt)" /> <span class="ml-2">Subject Name</span>
                  </th>
                  <th scope="col"
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr :key="quote.id" v-for="quote in quotes">
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <input type="checkbox" class="checkbox border quote-checkbox"
                      @change="(evt) => selecteQuote(quote.id, evt)" /> <span class="ml-2">{{ quote.product_or_service
                      }}</span>
                  </td>
                    ...
                    <div class="flex items-center">
                      <div class="flex-shrink-0 h-10 w-10">
                        ...
                        <div class="h-10 w-10 rounded-full bg-gray-100 flex justify-center items-center">
                          <span class="text-sky-950 font-bold">{{ `${quote.first_name[0].toUpperCase()}${quote.last_name[0].toUpperCase()}` }}</span>
                        </div>
                      </div>
                      <div class="ml-4">
